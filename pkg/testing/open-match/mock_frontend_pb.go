...
// Source: /home/shin5ok/repos/Others/open-match/pkg/pb/frontend.pb.go

// Package openmatchpb is a generated GoMock package.
package mockpb
...
func (m *MockFrontendServiceClient) DeleteBackfill(ctx context.Context, in *pb.DeleteBackfillRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockFrontendServiceClient) DeleteTicket(ctx context.Context, in *pb.DeleteTicketRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// DeleteBackfill mocks base method.
func (m *MockFrontendServiceServer) DeleteBackfill(arg0 context.Context, arg1 *pb.DeleteBackfillRequest) (*empty.Empty, error) {
	m.ctrl.T.Helper()
...
// DeleteTicket mocks base method.
func (m *MockFrontendServiceServer) DeleteTicket(arg0 context.Context, arg1 *pb.DeleteTicketRequest) (*empty.Empty, error) {
	m.ctrl.T.Helper()
